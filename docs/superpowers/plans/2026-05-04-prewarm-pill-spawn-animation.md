...
Run:
```bash
grep -n "case " "/Users/<user>/Documents/03_Profesional/Claude Projects/CyphrWhispr/CyphrWhispr/MenuBar/StatusItemController.swift" | head
```
...
open "/Users/<user>/Documents/03_Profesional/Claude Projects/CyphrWhispr/build/Build/Products/Debug/CyphrWhispr.app"
```
